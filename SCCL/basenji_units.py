...
#     def __init__(self, filters, kernel_size, pool_size = 1):
#         self.layer_GELU = GELU()
#         self.layer_Conv1D = tf.keras.layers.Conv1D(
#             filters=filters,
#             kernel_size=kernel_size,
#             strides=1,
#             padding="same",
...
#         )
#         self.layer_batchNorm = tf.keras.layers.BatchNormalization(momentum=0.9, gamma_initializer="zeros")
#         self.layer_pool = tf.keras.layers.MaxPool1D(pool_size=pool_size, padding="same")

#     def __call__(self, input):
#         step_0 = self.layer_GELU(input)
#         step_1 = self.layer_Conv1D(step_0)
#         step_2 = self.layer_batchNorm(step_1)
#         output = self.layer_pool(step_2)
#         return output

# class flatten_block(tf.keras.layers.Layer):
#     def __init__(self):
#         super(flatten_block, self).__init__()
#         self.layer_flatten = tf.keras.layers.Flatten()

#     def __call__(self, input):
#         output = self.layer_flatten(input)
#         return output

# class dense_block(tf.keras.layers.Layer):
#     def __init__(self, units, dropout):
#         super(dense_block, self).__init__()
#         # _, seq_len, seq_depth = input.shape
#         self.layer_GELU = GELU()
#         self.layer_reshape = tf.keras.layers.Reshape((1, 1792,))
#         # self.layer_reshape = tf.keras.layers.Reshape((1, seq_len * seq_depth,))
...
#         )
#         self.layer_batchNorm = tf.keras.layers.BatchNormalization(momentum=0.9, gamma_initializer="zeros")
#         self.layer_dropout = tf.keras.layers.Dropout(rate=dropout)

#     def __call__(self, input):
#         step_0 = self.layer_GELU(input)
#         step_1 = self.layer_reshape(step_0)
#         step_2 = self.layer_dense(step_1)
#         step_3 = self.layer_batchNorm(step_2)
#         output = self.layer_dropout(step_3)
#         return output
...
#     def __call__(self, input):
#         output = self.layer_dense(input)
#         return output


# class conv_tower(tf.keras.layers.Layer):
#     def __init__(self, filters_init, filters_end=None, filters_mult=None,
#         repeat=6, **kwargs):
#         super(conv_tower, self).__init__()

#         rep_filters = filters_init
#         re_mult = filters_mult
#         self.layer_conv1 = conv_block(filters=rep_filters, **kwargs)
#         rep_filters = rep_filters * re_mult
#         self.layer_conv2 = conv_block(filters=rep_filters, **kwargs)
#         rep_filters = rep_filters * re_mult
#         self.layer_conv3 = conv_block(filters=rep_filters, **kwargs)
#         rep_filters = rep_filters * re_mult
#         self.layer_conv4 = conv_block(filters=rep_filters, **kwargs)
#         rep_filters = rep_filters * re_mult
#         self.layer_conv5 = conv_block(filters=rep_filters, **kwargs)
#         rep_filters = rep_filters * re_mult
#         self.layer_conv6 = conv_block(filters=rep_filters, **kwargs)

#     def __call__(self, input):
#         step1 = self.layer_conv1(input)
#         step2 = self.layer_conv2(step1)
#         step3 = self.layer_conv3(step2)
#         step4 = self.layer_conv4(step3)
#         step5 = self.layer_conv5(step4)
#         output = self.layer_conv6(step5)
#         return output
